...
# keep-selection: после применения эффекта rofi перерисовывает список — без
# этого курсор прыгал бы в начало. С опцией позиция сохраняется, так что можно
# тыкать эффекты подряд, не листая заново (rofi >= 1.7; тут 2.0).
